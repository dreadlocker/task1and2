...
//#region task 1
const matchedMarkets = marketCategories.rules.reduce((a, b) => {
  const currentMarket = b["key"];
  if(markets[currentMarket]) a[currentMarket] = markets[currentMarket];
  return a;
}, {});
//#endregion

//#region task 2
const matchedMarketsSorterByOrder = Object.fromEntries(Object.entries(matchedMarkets).sort((arr1, arr2) => arr1[1].info.order - arr2[1].info.order));
//#endregion